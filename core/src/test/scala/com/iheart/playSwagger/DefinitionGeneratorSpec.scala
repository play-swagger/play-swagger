  ...
  "java class definition" >> {
    ...
    "generate properties" >> {
      ...
      "with correct long property" >> {
        result.filter(r => r.name == "id").head === GenSwaggerParameter(
          name = "id",
          `type` = Some("integer"),
          format = Some("int64"),
          required = false,
        ...
        result.filter(r => r.name == "aLong").head === GenSwaggerParameter(
          name = "aLong",
          `type` = Some("integer"),
          format = Some("int64"),
          required = false,
      ...
      "with correct int32 property" >> {
        result.filter(r => r.name == "integer").head === GenSwaggerParameter(
          name = "integer",
          `type` = Some("integer"),
          format = Some("int32"),
          required = false,
        ...
        result.filter(r => r.name == "anInt").head === GenSwaggerParameter(
          name = "anInt",
          `type` = Some("integer"),
          format = Some("int32"),
          required = false,
      ...
      "with correct double property" >> {
        result.filter(r => r.name == "aDouble").head === GenSwaggerParameter(
          name = "aDouble",
          `type` = Some("number"),
          format = Some("double"),
          required = false,
        ...
        result.filter(r => r.name == "double").head === GenSwaggerParameter(
          name = "double",
          `type` = Some("number"),
          format = Some("double"),
          required = false,
      ...
      "with correct float property" >> {
        result.filter(r => r.name == "float").head === GenSwaggerParameter(
          name = "float",
          `type` = Some("number"),
          format = Some("float"),
          required = false,
        ...
        result.filter(r => r.name == "aFloat").head === GenSwaggerParameter(
          name = "aFloat",
          `type` = Some("number"),
          format = Some("float"),
          required = false,
      ...
      "with correct java time property" >> {
        result.filter(r => r.name == "instant").head === GenSwaggerParameter(
          name = "instant",
          `type` = Some("string"),
        ...
        result.filter(r => r.name == "dayOfBirth").head === GenSwaggerParameter(
          name = "dayOfBirth",
          `type` = Some("string"),
          format = Some("date"),
          required = false,
        ...
        result.filter(r => r.name == "localDateTime").head === GenSwaggerParameter(
          name = "localDateTime",
          `type` = Some("string"),
          format = Some("date-time"),
          required = false,
      ...
      "with correct array property" >> {
        ...
        result.filter(r => r.name == "customKey").head === GenSwaggerParameter(
          name = "customKey",
          required = true,
          `type` = Some("array"),
          items = Some(itemsParam)
      ...
      "with correct string property" >> {
        result.filter(r => r.name == "firstName").head === GenSwaggerParameter(
          name = "firstName",
          `type` = Some("string"),
          required = false,
          nullable = Some(true)
      ...
      "with reference type" >> {
        result.filter(r => r.name == "attribute").head === GenSwaggerParameter(
          name = "attribute",
      ...
      "with java collection reference type" >> {
        ...
        result.filter(r => r.name == "attributeList").head === GenSwaggerParameter(
          name = "attributeList",
          `type` = Some("array"),
        ...
        result.filter(r => r.name == "attributeSet").head === GenSwaggerParameter(
          name = "attributeSet",
          `type` = Some("array"),
